...
import ExcelGrid from "@/modules/integra-lantek-ve/components/ExcelGrid";
import ValidationModal from "@/modules/integra-lantek-ve/components/ValidationModal";
import FeedbackModal from "@/modules/integra-lantek-ve/components/FeedbackModal";
import InfoPesquisaModal from "@/modules/integra-lantek-ve/components/InfoPesquisaModal";
import {
  buscarOrdens,
  exportarPlanilha,
  validarDxf,
} from "@/modules/integra-lantek-ve/services/processamentoOrdens.service";
import type {
  ApiIntegracaoItem,
  DxfValidacaoResultado,
  TabelaProcessamentoRow,
  TipoBusca,
} from "@/modules/integra-lantek-ve/types/processamentoOrdens.types";
import styles from "@/modules/integra-lantek-shared/ProcessamentoOrdensPage.module.css";
import { generateId } from "@/modules/integra-lantek-ve/utils/generateId";
import {
  extrairEspessuraDaDescricaoMp,
  inferirMaterialDaDescricaoMp,
} from "@/modules/integra-lantek-ve/utils/espessura";
