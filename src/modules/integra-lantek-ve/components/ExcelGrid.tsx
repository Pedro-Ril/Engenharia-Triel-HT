...
import type { TabelaProcessamentoRow } from "@/modules/integra-lantek-ve/types/processamentoOrdens.types";
import { formatarEspessura } from "@/modules/integra-lantek-ve/utils/espessura";
import DesenhoViewerModal from "@/modules/integra-lantek-ve/components/DesenhoViewerModal";
...
// --- Ajuste 1: interface para o plugin de filtros no lugar de `any` ---
...
const OPCOES_MAQUINA = ["CALFRAN Laser 6Kw VE"];
