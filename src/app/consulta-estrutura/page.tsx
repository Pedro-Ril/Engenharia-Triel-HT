                  ...
                  {registrosSelecionados.map((registro, index) => (
                    ...
                    >
                      ...
                      <div className={styles.recordRow}>
                        ...
                        <span>
                          {registro.COD_ITEM_FILHO} - {registro.DESC_TECNICA_FILHO}
                        </span>
                      </div>
                      ...
                      <div className={styles.recordRow}>
                        ...
                        <span
                          className={
                            registro.STATUS_VALIDADE?.toUpperCase() === "INVALIDO"
                              ? styles.invalidText
                              : styles.validText
                          }
                        >
                      ...
                      <div className={styles.recordRow}>
                        <span className={styles.recordLabel}>Ordem hierárquica</span>
